...
class Place:
    ...
    def ownedByThisPlayer(self, player):
...
class CatanGraph:
    def __init__(self):
        ...
        self.places = [Place(x) for x in range(0, 54)]
        ...
        self.harbors = ["2:1 wood", "2:1 crop", "2:1 sheep", "2:1 iron", "2:1 clay", "3:1", "3:1", "3:1", "3:1"] 
