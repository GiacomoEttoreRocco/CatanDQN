...
HighT = ReinforcementLearningStrategyGnnHier(0)
HighT.loadWeights("Weights/HighTrainedHierGnn/weights"+str(0)+"-1000")

HighT2k = ReinforcementLearningStrategyGnnHier(0)
HighT2k.loadWeights("Weights/HighTrainedHierGnn/weights"+str(0)+"-2000")

HighT3k = ReinforcementLearningStrategyGnnHier(0)
HighT3k.loadWeights("Weights/HighTrainedHierGnn/weights"+str(0)+"-2000")
...
# otherAgents = [EURISTIC_PLAYER, RANDOM_PLAYER, HighT2k, HighT3k]
otherAgents = [EURISTIC_PLAYER, RANDOM_PLAYER, HighT, HighT2k]


glob = 0.0
totalGames = 0.0

# examAgent = H_GNN1_blue # HighT # H_GNN1_self
examAgent = HighT3k # H_GNN1_self
...
for agent in otherAgents:
    ...
    print(yourName + "and " + agent.name() + " over. Winrate: ", wons,  "/5.0 " , "MeansAt120: ", meansAt120/10.0)
